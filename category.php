    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <?php while ($blogrow = mysqli_fetch_array($result)) { ?>
                <div class="card mb-4">
                    <a href="post.php?postid=<?= base64_encode($blogrow['id']); ?>"><img class="card-img-top" src="uploads/<?= $blogrow['photo'] ?>" style="width: 100%; height: 400px;" alt="Blog" ></a>
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary" href="post.php?postid=<?= base64_encode($blogrow['id']); ?>">Read more →</a>
                    </div>
                </div>
            <?php } ?>
        </div>
